        ...
        >
          <div className="relative w-full max-w-sm rounded-2xl bg-[#0b1020] border border-indigo-500/30 p-5 shadow-2xl shadow-black text-white space-y-4">
            ...
            <button
              type="button"
              onClick={() => setShowInstructionsModal(false)}
              className="w-full py-2 px-3 text-xs font-semibold rounded-lg bg-white/10 hover:bg-white/15 text-white transition-colors cursor-pointer border border-white/10 text-center"
            >
              Got it
            </button>
          </div>
